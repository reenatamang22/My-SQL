...
SELECT a.AccountID, a.AccountType, a.Balance, a.CustomerID,t.TransactionID,
t.TransactionDate,t.TransactionType,t.Amount
FROM Accounts a
INNER JOIN Transactions t
ON a.AccountID = t.AccountID
WHERE a.Balance > 30000;

SELECT AccountID,AccountType,Balance,CustomerID,TransactionID,TransactionDate,
